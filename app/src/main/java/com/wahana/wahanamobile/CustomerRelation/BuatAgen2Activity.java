...
public class BuatAgen2Activity extends DrawerHelper implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_agen2);
        db = new DatabaseHandler(BuatAgen2Activity.this);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BuatAgen2Activity.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent pindah = new Intent(BuatAgen2Activity.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("Settings",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BuatAgen2Activity.this.startActivity(intent);
                            finish();
                        }
                    });
        ...
        progressDialog = new ProgressDialog(BuatAgen2Activity.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(BuatAgen2Activity.this);
    ...
    private void submitForm() {
        startActivity(new Intent(BuatAgen2Activity.this, BuatAgen3Activity.class));
    }
