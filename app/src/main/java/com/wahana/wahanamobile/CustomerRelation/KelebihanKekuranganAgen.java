...
public class KelebihanKekuranganAgen extends DrawerHelper {
    private static final String TAG = "KelebihanKekuranganAgen";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kelebihan_kekurangan_agen);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(KelebihanKekuranganAgen.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent pindah = new Intent(KelebihanKekuranganAgen.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("Settings",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            KelebihanKekuranganAgen.this.startActivity(intent);
                            finish();
                        }
                    });
        ...
        progressDialog = new ProgressDialog(KelebihanKekuranganAgen.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(KelebihanKekuranganAgen.this);
    ...
    private void submitForm() {
        startActivity(new Intent(KelebihanKekuranganAgen.this, SalesMainActivity.class));
    }
    /**
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                startActivity(new Intent(KelebihanKekuranganAgen.this, AttendanceReport.class));
                break;
            case 3:
                session.logoutUser();
                break;
