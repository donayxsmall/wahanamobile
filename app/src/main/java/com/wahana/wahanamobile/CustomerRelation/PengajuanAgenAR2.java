...
public class PengajuanAgenAR2 extends DrawerHelper implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    Spinner provinsiSpinner,kelurahanSpinner,kecamatanSpinner,kabkotSpinner;
    public ArrayAdapter<CharSequence> adapter;
    //private ImageView imageView;
    private static final String TAG = "PengajuanAgenAR2";
    ...
    TextView latitude_label, longitude_label, provinsi_label, kabkot_label, kelurahan_label, kecamatan_label, alamat_agen_label;
    ImageView foto, iv;
    DatabaseHandler db;
    String nomorTTK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengajuan_agen_ar2);
        db = new DatabaseHandler(PengajuanAgenAR2.this);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PengajuanAgenAR2.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent pindah = new Intent(PengajuanAgenAR2.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("Settings",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            PengajuanAgenAR2.this.startActivity(intent);
                            finish();
                        }
                    });
        ...
        progressDialog = new ProgressDialog(PengajuanAgenAR2.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(PengajuanAgenAR2.this);
    ...
    private void submitForm() {
        startActivity(new Intent(PengajuanAgenAR2.this, PengajuanAgenAR3.class));
    }
