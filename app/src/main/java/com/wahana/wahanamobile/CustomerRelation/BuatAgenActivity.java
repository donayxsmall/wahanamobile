...
public class BuatAgenActivity extends DrawerHelper{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_agen);
        super.onCreateDrawer(this);
        db = new DatabaseHandler(BuatAgenActivity.this);
        ////////////////////////////////////////////////
        //        TOOLBAR SECTION
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BuatAgenActivity.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent pindah = new Intent(BuatAgenActivity.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("Settings",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            BuatAgenActivity.this.startActivity(intent);
                            finish();
                        }
                    });
        ...
        progressDialog = new ProgressDialog(BuatAgenActivity.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(BuatAgenActivity.this);
...
//        btnClickImage.setOnClickListener(this);
    ...
    private void submitForm() {
        startActivity(new Intent(BuatAgenActivity.this, BuatAgen2Activity.class));
    }
