...
import com.wahana.wahanamobile.CustomerRelation.BuatAgen2Activity;
...
public class PendaftaranCalonAgen extends DrawerHelper {
    ...
    TextView nama,jabatan, nama_agen_label, no_ktp_label,no_handphone_label,email_agen_label, penanggung_jawab_label, alamat_agen_label;
    ImageView foto;
    DatabaseHandler db;
    String nomorTTK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pendaftaran_calon_agen);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PendaftaranCalonAgen.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("OK",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Intent pindah = new Intent(PendaftaranCalonAgen.this, MainActivity.class);
            ...
            alertDialog.setPositiveButton("Settings",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            PendaftaranCalonAgen.this.startActivity(intent);
                            finish();
                        }
                    });
        ...
        progressDialog = new ProgressDialog(PendaftaranCalonAgen.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(PendaftaranCalonAgen.this);
...
//        btnClickImage.setOnClickListener(this);
    ...
    private void submitForm() {
        startActivity(new Intent(PendaftaranCalonAgen.this, PendaftaranCalonAgen2.class));
    }
