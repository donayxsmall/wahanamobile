...
//    private DownloadTask activity1;
    ...
    public DownloadTaskPU(Context context, Button buttonText, String downloadUrl,String kodeagen) {
...
//        down(downloadFileName);
    ...
    public void readpdf(String namefile){
        File pdfFile = new File(Environment.getExternalStorageDirectory() + "/WahanaFolder/PickupRetail/PDF/" + namefile);  // -> filename = maven.pdf
