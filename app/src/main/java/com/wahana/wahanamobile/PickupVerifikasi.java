...
public class PickupVerifikasi extends DrawerHelper {
    private static final String TAG = "PickVerifikasi";
...
//        });
        ...
        progressDialog = new ProgressDialog(PickupVerifikasi.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(PickupVerifikasi.this);
        user_id = session.getID();
        db = new DatabaseHandler(PickupVerifikasi.this);
...
//        new DownloadTask(PickupVerifikasi.this,btnInput,urllink,"pu");
...
private void coba(){
    Intent picture_intent = new Intent(PickupVerifikasi.this, ReportPageActivity.class);
...
////                            });
//
//                            final AlertDialog.Builder adb=new AlertDialog.Builder(PickupVerifikasi.this);
//                            adb.setTitle("Info");
...
//
//                                    Intent intent = new Intent(PickupVerifikasi.this, PickupScanner.class);
...
//                                    Intent pindah = new Intent(PickupVerifikasi.this, PreviewResultScanner.class);
...
//
//                    }else{
//                        Toast.makeText(PickupVerifikasi.this,vrmsg,Toast.LENGTH_SHORT).show();
//                    }
//
//
//
...
//    }
    ...
    private void submitFormRest(){
        ...
        Call<PickupVerify> result = mApiInterface.pickupVerifyRest(session.getSessionID(),session.getID(),agentcode,inputVerifikasi.getText().toString());

        progressDialog.setIndeterminate(true);
        progressDialog.setMessage("Authenticating...");
        progressDialog.show();

        result.enqueue(new Callback<PickupVerify>() {

            @Override
            public void onResponse(Call<PickupVerify> call, Response<PickupVerify> response) {
                try {
...
//                        Toast.makeText(PickupActivity.this," response version "+response.body().getVerificationCode(),Toast.LENGTH_SHORT).show();
                    ...
                    e.printStackTrace();
                    Toast.makeText(PickupVerifikasi.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    progressDialog.dismiss();
                }
            ...
            @Override
            public void onFailure(Call<PickupVerify> call, Throwable t) {
                progressDialog.dismiss();
                t.printStackTrace();
                Toast.makeText(PickupVerifikasi.this,"error"+""+t.toString(),Toast.LENGTH_SHORT).show();
//                Log.d("error",""+t.toString());
            }
        });
                ...
                if(result==null){
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(PickupVerifikasi.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
