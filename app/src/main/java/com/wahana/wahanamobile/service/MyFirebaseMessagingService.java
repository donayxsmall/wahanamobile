...
import com.wahana.wahanamobile.MemberAirways;
import com.wahana.wahanamobile.Ops.ReportPageActivity;
import com.wahana.wahanamobile.utils.NotificationUtils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            Log.d("hasil firebase",""+info);

//            String[] parts = info.split(":");
//            String info1=parts[0];
//            String info2=parts[1];
...
//                Intent resultIntent = new Intent(getApplicationContext(), MemberAirways.class);
//                resultIntent.putExtra("message", message);


                Intent resultIntent = new Intent(getApplicationContext(), ReportPageActivity.class);
                resultIntent.putExtra("url", "http://intranet.wahana.com/ci-oauth2/home/listttk?user="+info);
