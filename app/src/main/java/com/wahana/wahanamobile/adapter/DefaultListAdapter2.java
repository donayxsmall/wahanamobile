 ...
 */
public class DefaultListAdapter2  extends ArrayAdapter<DemoItem> implements DemoAdapter {
    ...
    public DefaultListAdapter2(Context context, List<DemoItem> items) {
        super(context, 0, items);
        layoutInflater = LayoutInflater.from(context);
    }

    public DefaultListAdapter2(Context context) {
        super(context, 0);
        layoutInflater = LayoutInflater.from(context);
    }
...
//        layout_kotak = (ImageView) v.findViewById(R.id.layout_kotak);
        String planet = getContext().getResources().getStringArray(R.array.menuuser)[position];
        String judul = getContext().getResources().getStringArray(R.array.juduluser)[position];
