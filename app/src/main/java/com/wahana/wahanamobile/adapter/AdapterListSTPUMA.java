...
public class AdapterListSTPUMA extends BaseAdapter {
...
//    }
    ...
    public AdapterListSTPUMA(Activity a,  List<ListTtkSTPUMA> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public AdapterListSTPUMA(Activity a,  List<ListTtkSTPUMA> ttk, String asal) {
        activity = a;
        this.ttk = ttk;
        this.asal = asal;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
