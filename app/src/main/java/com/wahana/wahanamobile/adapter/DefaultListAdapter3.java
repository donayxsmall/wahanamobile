...
/**
 * Created by Reza on 08/01/2017.
 */
public class DefaultListAdapter3  extends ArrayAdapter<DemoItem> implements DemoAdapter  {
    ...
    public DefaultListAdapter3(Context context, List<DemoItem> items) {
        super(context, 0, items);
        layoutInflater = LayoutInflater.from(context);
    }

    public DefaultListAdapter3(Context context) {
        super(context, 0);
        layoutInflater = LayoutInflater.from(context);
    }
...
//        layout_kotak = (ImageView) v.findViewById(R.id.layout_kotak);
        String planet = getContext().getResources().getStringArray(R.array.menusales)[position];
        String judul = getContext().getResources().getStringArray(R.array.judulsales)[position];
