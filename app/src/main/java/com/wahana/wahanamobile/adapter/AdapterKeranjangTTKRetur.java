...
public class AdapterKeranjangTTKRetur extends BaseAdapter {
...
//    }
    ...
    public AdapterKeranjangTTKRetur(Activity a,  List<TtkKeranjangRetur> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public AdapterKeranjangTTKRetur(Activity a,  List<TtkKeranjangRetur> ttk, String asal) {
        activity = a;
        this.ttk = ttk;
        this.asal = asal;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
