...
public class LihatPreviewAdapterBongkarMA extends BaseAdapter {
    ...
    public LihatPreviewAdapterBongkarMA(Activity a, List<ListTtkBongkarMA> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        LihatPreviewAdapterBongkarMA.Holder holder=new LihatPreviewAdapterBongkarMA.Holder();
