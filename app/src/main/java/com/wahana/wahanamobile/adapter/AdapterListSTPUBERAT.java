...
/**
 * Created by donay on 27/08/20.
 */

public class AdapterListSTPUBERAT extends BaseAdapter {
...
//    }
    ...
    public AdapterListSTPUBERAT(Activity a,  List<ListTtkSTPUBERAT> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public AdapterListSTPUBERAT(Activity a,  List<ListTtkSTPUBERAT> ttk, String asal) {
        activity = a;
        this.ttk = ttk;
        this.asal = asal;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
