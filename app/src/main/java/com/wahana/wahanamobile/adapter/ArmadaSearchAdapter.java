 ...
 */
public class ArmadaSearchAdapter extends BaseAdapter {
    ...
    List<Origin> searchList2=new ArrayList<Origin>();

    public ArmadaSearchAdapter(Activity a, List<Origin> origin) {
        activity = a;
        this.originList = origin;
        this.searchList.addAll(originList);
        this.searchList2.addAll(originList);
...
//        holder.lokasiIsi.setText(ori.getProvince()+", "+ori.getCity());
        holder.lokasiId.setText(ori.getCity());
