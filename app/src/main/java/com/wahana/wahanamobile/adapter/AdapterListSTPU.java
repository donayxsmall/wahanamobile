...
public class AdapterListSTPU extends BaseAdapter {
...
//    }
    ...
    public AdapterListSTPU(Activity a,  List<ListTtkPickup> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public AdapterListSTPU(Activity a,  List<ListTtkPickup> ttk, String asal) {
        activity = a;
        this.ttk = ttk;
        this.asal = asal;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
