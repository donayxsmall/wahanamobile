...
public class AdapterListPickup extends BaseAdapter {
...
//    }
    ...
    public AdapterListPickup(Activity a,  List<ListTtkPickup> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public AdapterListPickup(Activity a,  List<ListTtkPickup> ttk, String asal) {
        activity = a;
        this.ttk = ttk;
        this.asal = asal;
        inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
            view = inflater.inflate(R.layout.buat_pu_listview, null);
