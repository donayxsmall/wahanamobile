...
/**
 * Created by Reza on 31/03/2017.
 */
public class DefaultListAdapter5 extends ArrayAdapter<DemoItem> implements DemoAdapter
{
    ...
    public DefaultListAdapter5(Context context, List<DemoItem> items) {
        super(context, 0, items);
        layoutInflater = LayoutInflater.from(context);
    }

    public DefaultListAdapter5(Context context) {
        super(context, 0);
        layoutInflater = LayoutInflater.from(context);
    }
...
//        layout_kotak = (ImageView) v.findViewById(R.id.layout_kotak);
        String planet = getContext().getResources().getStringArray(R.array.menuar)[position];
        String judul = getContext().getResources().getStringArray(R.array.judular)[position];
