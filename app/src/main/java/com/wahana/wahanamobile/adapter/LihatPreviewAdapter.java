...
public class LihatPreviewAdapter extends BaseAdapter {
    ...
    public LihatPreviewAdapter(Activity a,  List<BuatSJ> ttk, int urut) {
        activity = a;
        Urut = urut;
        this.ttk = ttk;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        LihatPreviewAdapter.Holder holder=new LihatPreviewAdapter.Holder();
