 ...
 */
public class SortableDeliveryListTableView extends SortableTableView<Kode> {
    public SortableDeliveryListTableView(Context context) {
        this(context, null);
    }

    public SortableDeliveryListTableView(Context context, AttributeSet attributes) {
        this(context, attributes, android.R.attr.listViewStyle);
    }

    public SortableDeliveryListTableView(Context context, AttributeSet attributes, int styleAttributes) {
        super(context, attributes, styleAttributes);


        SimpleTableHeaderAdapter simpleTableHeaderAdapter = new SimpleTableHeaderAdapter(context, "Nomor TTK", "Koli","Berat","Status");
