...
public class SearchMobilMa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_mobil_ma);
...
//        });
        ...
        db = new DatabaseHandler(SearchMobilMa.this);
        db.deleteOrigin();
        session = new SessionManager(SearchMobilMa.this);
        ...
        progressDialog = new ProgressDialog(SearchMobilMa.this, R.style.AppTheme_Dark_Dialog);
        ArrayList<String> parameter = new ArrayList<String>();
        parameter.add("doSSQL");
        parameter.add(session.getSessionID());
        parameter.add("getActiveArmadaById");
        parameter.add("0");
        parameter.add("0");
        parameter.add("0");
        parameter.add("0");
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(SearchMobilMa.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                        }
                    });
                }else {
                    try{
...
//                                        db.addOrigin(ori);
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(SearchMobilMa.this, "Data Tidak Ada",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(SearchMobilMa.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
...
//                Log.d("hasil", isi.getText().toString());
                Intent pindah = new Intent(SearchMobilMa.this, AddDataMAActivity.class);
...
//        originList = db.getAllDataOrigin(inputLoc.getText().toString());
        adapter = new ArmadaSearchAdapter(SearchMobilMa.this, originList);
...
//                lv.setAdapter(mAdapter);
                ...
                adapter = new ArmadaSearchAdapter(SearchMobilMa.this, tempArrayList);
                listViewTestSearch.setAdapter(adapter);
                listViewTestSearch.setVisibility(View.VISIBLE);
