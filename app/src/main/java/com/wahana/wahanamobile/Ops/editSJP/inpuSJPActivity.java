...
public class inpuSJPActivity extends DrawerHelper {
    private static final String TAG = "inputMSActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_sjp);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(inpuSJPActivity.this, OpsMainActivity.class);
        ...
        progressDialog = new ProgressDialog(inpuSJPActivity.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(inpuSJPActivity.this);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(inpuSJPActivity.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                Intent pindah = new Intent(inpuSJPActivity.this, updateSJPActivity.class);
                                pindah.putExtra("sjp",inputVerifikasi.getText().toString().toUpperCase());
                                startActivity(pindah);
                                finish();
                            }else{
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(inpuSJPActivity.this, "No SJP Tidak Terdaftar",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(inpuSJPActivity.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
    ...
    private boolean validateKode() {
        if (inputVerifikasi.getText().toString().trim().isEmpty()) {
            inputVerifikasi.setError("Masukkan No SJP");

            Toast.makeText(inpuSJPActivity.this,"Masukkan Nomor SJP", Toast.LENGTH_LONG).show();
