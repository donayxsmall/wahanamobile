package com.wahana.wahanamobile.Ops.salahtempel;
...
public class tandaisalahtempel extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(tandaisalahtempel.this);
        ...
        progressDialog = new ProgressDialog(tandaisalahtempel.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(tandaisalahtempel.this);
        ...
        judul_status_terkirim_isi.setText("Tandai Salah Tempel");
...
//        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder adb=new AlertDialog.Builder(tandaisalahtempel.this);
                adb.setTitle("Tandai TTK Salah Tempel");
    ...
    private void submitForm() {
        ...
        try {
            json.put("service", "settandaisalahtempel");
                ...
                if (result == null) {
                    runOnUiThread(new Runnable() {
                        public void run() {progressDialog.dismiss();
                                Toast.makeText(tandaisalahtempel.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            Toast.makeText(tandaisalahtempel.this, getString(R.string.update_airway_message), Toast.LENGTH_LONG).show();
                            finish();
                        } else {
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(tandaisalahtempel.this, text, Toast.LENGTH_LONG).show();
                                    progressDialog.dismiss();
                                }
                            });
                        }
...
//                    break;
    ...
    public boolean validate() {
        ...
        if (imageView.getDrawable() == null){
            Toast.makeText(tandaisalahtempel.this, "Mohon Masukkan Foto", Toast.LENGTH_SHORT).show();
            valid = false;
        }
