...
public class SerahTerimaMSActivity extends Activity implements ZBarScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(SerahTerimaMSActivity.this, R.style.AppTheme_Dark_Dialog);

        Intent intent = getIntent();
        ms = intent.getStringExtra("ms");

        session = new SessionManager(SerahTerimaMSActivity.this);
        employeeCode = session.getID();

        listTTK = (ListView) findViewById(R.id.list_ttk_daftar);
        db = new DatabaseHandler(SerahTerimaMSActivity.this);
        db.deleteSTMS();
        ...
        addManual.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(SerahTerimaMSActivity.this);
                alertDialog.setTitle("Input Manual TTK");
                alertDialog.setMessage("Masukkan no. TTK");

                final EditText input = new EditText(SerahTerimaMSActivity.this);
...
//                                }
                                ...
                                Log.d("Hasil", ""+ttk);
                                if (ttk==0){
                                    mySong= MediaPlayer.create(SerahTerimaMSActivity.this, R.raw.success);
                                    mySong.start();
        ...
        listTTK.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                AlertDialog.Builder adb=new AlertDialog.Builder(SerahTerimaMSActivity.this);
...
//                                Log.d("hasil soap data", ""+d.getJSONObject(1).getString("status"));
    ...
    private void populate(){
        ...
        Log.d("Hasil", ""+ttkList);
        adapter = new BuatSJAdapter(SerahTerimaMSActivity.this, ttkList, urut);
...
//        }
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mScannerView.resumeCameraPreview(SerahTerimaMSActivity.this);
            }
        }, 2000);
    }
