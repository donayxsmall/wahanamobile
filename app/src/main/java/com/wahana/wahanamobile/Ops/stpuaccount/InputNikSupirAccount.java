...
public class InputNikSupirAccount extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_nik_supir_account);

        //get force close
        Thread.setDefaultUncaughtExceptionHandler(new UnCaughtException(InputNikSupirAccount.this));
        ...
        db = new DatabaseHandler(InputNikSupirAccount.this);

        progressDialog = new ProgressDialog(InputNikSupirAccount.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(InputNikSupirAccount.this);
...
//    public void refresh(){
//        Call<Tracking> result = mApiInterface.getResultInfo("als78787");
//        result.enqueue(new Callback<Tracking>() {
//            @Override
//            public void onResponse(Call<Tracking> call, Response<Tracking> response) {
//                try {
//
//                    List<ResultTracking> data =  response.body().getData();
//
//                    for(int i = 0; i<data.size(); i++){
//                        Toast.makeText(InputNikSupir.this," response version "+data.get(i).getTrackstatusnama(),Toast.LENGTH_SHORT).show();
//
//                        Log.d("retro",""+data.get(i).getTanggalHistory());
//                    }
//
//                }catch (Exception e){
//                    e.printStackTrace();
...
//        db.importscvSTPU(cls.ty());
        ...
        Call<ApiPickup> result = mApiInterface.genTTKstpuAccount(input_nik_supir.getText().toString());
...
//                        }
                        ...
                        Intent intent = new Intent(InputNikSupirAccount.this, StpuKodeSortirAccount.class);
                        intent.putExtra("niksupir",input_nik_supir.getText().toString());
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        finish();
...
//                        Log.d("retro",""+vurl);
                        ...
                        Toast.makeText(InputNikSupirAccount.this," error "+vrmsg,Toast.LENGTH_SHORT).show();
                    }
