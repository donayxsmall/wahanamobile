...
public class inputTTKSelisihBerat extends DrawerHelper {
    private static final String TAG = "inputTTKSelisihBerat";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(inputTTKSelisihBerat.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(inputTTKSelisihBerat.this);
    ...
    private void submitForm() {
        ...
        parameter.add("checkSelisihBerat");
        parameter.add("0");
        parameter.add("0");
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(inputTTKSelisihBerat.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(inputTTKSelisihBerat.this, "TTK sudah diproses selisih berat",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }else{
                                Intent pindah = new Intent(inputTTKSelisihBerat.this, selisihBeratActivity.class);
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(inputTTKSelisihBerat.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
