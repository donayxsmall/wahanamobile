...
public class StpuKodeSortir extends AppCompatActivity {
    ...
    String kodeverifikasi,niksupir,cara;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_stpu_kode_sortir);

        //get force close
        Thread.setDefaultUncaughtExceptionHandler(new UnCaughtException(StpuKodeSortir.this));
        ...
        cara=intent.getStringExtra("cara");

        db = new DatabaseHandler(StpuKodeSortir.this);

        mApiInterface = ApiClient.getClient().create(UserAPIService.class);

        progressDialog = new ProgressDialog(StpuKodeSortir.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(StpuKodeSortir.this);
    ...
    public void submitForm(){
        ...
        Call<ApiPickup> result = mApiInterface.genTTKwithKodeSortirSTPU(niksupir,inputkodesortir.getText().toString());
            ...
            public void onResponse(Call<ApiPickup> call, Response<ApiPickup> response) {
                try {
                    ...
                    if(vrcode.equals("1")){
                        ...
                        new DownloadTask(StpuKodeSortir.this,btnInput,vurl,"stpu",vFile);
                        ...
                        if(histPickup==1){
                            ...
                            AlertDialog.Builder adb=new AlertDialog.Builder(StpuKodeSortir.this);
                            adb.setTitle("Info");
                            ...
                            adb.setNegativeButton("Tidak", new AlertDialog.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if(cara.equals("manual")) {

                                        Intent intent = new Intent(StpuKodeSortir.this, StpuScanner.class);
                                        ...
                                        Intent intent = new Intent(StpuKodeSortir.this, StpuScannerHardware.class);
                                        intent.putExtra("niksupir", niksupir);
                                        intent.putExtra("kodesortir", inputkodesortir.getText().toString());
                                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                        startActivity(intent);
                        ...
                        Toast.makeText(StpuKodeSortir.this,vrmsg,Toast.LENGTH_SHORT).show();
                    }
