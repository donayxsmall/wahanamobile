...
public class tandairejectxray extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(tandairejectxray.this);
        ...
        progressDialog = new ProgressDialog(tandairejectxray.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(tandairejectxray.this);
...
//        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder adb=new AlertDialog.Builder(tandairejectxray.this);
                adb.setTitle("Tandai TTK Reject X-RAY");
                ...
                if (result == null) {
                    runOnUiThread(new Runnable() {
                        public void run() {progressDialog.dismiss();
                                Toast.makeText(tandairejectxray.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                        }
                    });
                } else {
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            Toast.makeText(tandairejectxray.this, getString(R.string.update_airway_message), Toast.LENGTH_LONG).show();
                            finish();
                        } else {
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(tandairejectxray.this, text, Toast.LENGTH_LONG).show();
                                    progressDialog.dismiss();
                                }
                            });
                        }
...
//                    break;
    ...
    public boolean validate() {
        ...
        if (imageView.getDrawable() == null){
            Toast.makeText(tandairejectxray.this, "Mohon Masukkan Foto", Toast.LENGTH_SHORT).show();
            valid = false;
        }
