...
public class inputMSActivity extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_ms);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(inputMSActivity.this, OpsMainActivity.class);
        ...
        progressDialog = new ProgressDialog(inputMSActivity.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(inputMSActivity.this);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(inputMSActivity.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(inputMSActivity.this, "Manifest kota tujuan tidak sesuai",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(inputMSActivity.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
