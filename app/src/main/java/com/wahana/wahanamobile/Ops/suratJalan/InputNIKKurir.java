...
public class InputNIKKurir extends DrawerHelper {
    private static final String TAG = "InputNIKKurir1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_nikkurir);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InputNIKKurir.this, OpsMainActivity.class);
        ...
        progressDialog = new ProgressDialog(InputNIKKurir.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(InputNIKKurir.this);
...
//                Log.d("Lokasi",""+String.valueOf(latitude)+" | "+String.valueOf(longitude));
    ...
    private void submitForm() {
        ...
        parameter.add("whnGetBAKurirByNoSpv");
        parameter.add("5");
        parameter.add("0");
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(InputNIKKurir.this, getString(R.string.error_connection), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                ...
                                if (d.getInt(1) != 2){
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(InputNIKKurir.this, "Kurir sudah tidak Aktif",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            try {
                                                Toast.makeText(InputNIKKurir.this, "Kurir ini memiliki TTK yang belum terupdate statusnya: "+d.getInt(2)+" dalam proses pengiriman dan "+d.getInt(3)+" belum serah terima BT",Toast.LENGTH_LONG).show();
                                    ...
                                    Intent pindah = new Intent(InputNIKKurir.this, InputViaKurir.class);
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(InputNIKKurir.this, "Kode kantor tidak sesuai",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(InputNIKKurir.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(InputNIKKurir.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        });
                    }
    ...
    private boolean validateKode() {
        if (inputVerifikasi.getText().toString().trim().isEmpty()) {
            inputVerifikasi.setError("Masukkan NIK Kurir");
...
//        FusedLocation fusedLocation = new FusedLocation(InputNIKKurir.this, new FusedLocation.Callback(){
//            @Override
...
//
//                Toast.makeText(InputNIKKurir.this,
