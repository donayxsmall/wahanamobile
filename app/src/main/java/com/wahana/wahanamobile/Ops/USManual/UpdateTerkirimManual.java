...
public class UpdateTerkirimManual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_terkirim_manual);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(UpdateTerkirimManual.this, OpsMainActivity.class);
        ...
        progressDialog = new ProgressDialog(UpdateTerkirimManual.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(UpdateTerkirimManual.this);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(UpdateTerkirimManual.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                ...
                                Intent pindah = new Intent(UpdateTerkirimManual.this, DetailTTKUSterkirimmanual.class);
                                pindah.putExtra("ttk",input_ttk.getText().toString().toUpperCase());
...
//                                finish();
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(UpdateTerkirimManual.this, "No TTK tidak terdaftar",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(UpdateTerkirimManual.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
    ...
    private boolean validateKode() {
        if (input_ttk.getText().toString().trim().isEmpty()) {
            ...
            Toast.makeText(UpdateTerkirimManual.this,"Masukkan Nomor TTK", Toast.LENGTH_LONG).show();
