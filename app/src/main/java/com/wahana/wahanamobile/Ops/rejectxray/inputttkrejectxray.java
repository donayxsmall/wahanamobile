...
public class inputttkrejectxray extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(inputttkrejectxray.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(inputttkrejectxray.this);
...
//        Intent pindah = new Intent(inputttkrejectxray.this, tandairejectxray.class);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(inputttkrejectxray.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(inputttkrejectxray.this, "TTK tidak ditemukan",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(inputttkrejectxray.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
