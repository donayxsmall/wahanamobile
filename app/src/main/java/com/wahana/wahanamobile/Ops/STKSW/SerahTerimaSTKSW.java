package com.wahana.wahanamobile.Ops.STKSW;
...
public class SerahTerimaSTKSW extends Activity implements ZBarScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_serah_terima_stksw);

        progressDialog = new ProgressDialog(SerahTerimaSTKSW.this, R.style.AppTheme_Dark_Dialog);

        session = new SessionManager(SerahTerimaSTKSW.this);
        employeeCode = session.getID();

        listTTK = (ListView) findViewById(R.id.list_ttk_daftar);
        db = new DatabaseHandler(SerahTerimaSTKSW.this);
        db.deleteSTMS();
        ...
        addManual.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(SerahTerimaSTKSW.this);
                alertDialog.setTitle("Input Manual TTK");
                alertDialog.setMessage("Masukkan no. TTK");

                final EditText input = new EditText(SerahTerimaSTKSW.this);
...
//                                if (!isTTK(ttkManual)) {
//                                    mySong= MediaPlayer.create(SerahTerimaMSActivity.this, R.raw.error);
//                                    mySong.start();
//                                    Toast.makeText(getApplicationContext(), "TTK tidak sesuai", Toast.LENGTH_SHORT).show();
//                                    return;
//                                }
                                int ttk = db.checkSTMS(ttkManual);
                                Log.d("Hasil", ""+ttk);
                                if (ttk==0){
                                    mySong= MediaPlayer.create(SerahTerimaSTKSW.this, R.raw.success);
                                    mySong.start();
                                    ...
                                    mySong= MediaPlayer.create(SerahTerimaSTKSW.this, R.raw.error);
                                    mySong.start();
        ...
        listTTK.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                AlertDialog.Builder adb=new AlertDialog.Builder(SerahTerimaSTKSW.this);
                ...
                adb.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.deleteTTKSW(nottk.getText().toString());
                        populate();
                    }});
                adb.show();
            }
    ...
    private void submitForm() {
        ...
        try {
            json.put("service", "setDataSTKSalahWilayah");
//            json.put("ms", ms);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(SerahTerimaSTKSW.this, getString(R.string.error_connection), Toast.LENGTH_LONG).show();
...
//                                Log.d("hasil soap data", ""+d.getJSONObject(1).getString("status"));
                                if (d.getJSONObject(1).getString("status").equals("1")){
                                    ...
                                    Intent pindah = new Intent(SerahTerimaSTKSW.this, HasilProses.class);
                                    pindah.putExtra("proses","stksw");
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(SerahTerimaSTKSW.this, "Mohon Cek Kembali TTK Anda",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }else{
                            ...
                            progressDialog.dismiss();
                            Intent pindah = new Intent(SerahTerimaSTKSW.this, HasilError.class);
                            pindah.putExtra("proses","stksw");
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(SerahTerimaSTKSW.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        });
                    }
    ...
    private void populate(){
        ...
        Log.d("Hasil", ""+ttkList);
        adapter = new BuatSJAdapter(SerahTerimaSTKSW.this, ttkList, urut);
    ...
    public void handleResult(Result rawResult) {
        int ttk = db.checkSTMS(rawResult.getContents().toUpperCase());
        Log.d("Hasil", ""+ttk);
...
//        }
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mScannerView.resumeCameraPreview(SerahTerimaSTKSW.this);
            }
        }, 2000);
    }
