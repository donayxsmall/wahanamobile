...
public class TandaiDestroy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tandai_destroy);

        Intent intent=getIntent();
        nottk=intent.getStringExtra("nottk");
...
//        });
        ...
        progressDialog = new ProgressDialog(TandaiDestroy.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(TandaiDestroy.this);
        ...
        btn_submit_foto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TandaiDestroy.this, Camerates.class);
        ...
        btnInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                submitForm();
                AlertDialog.Builder adb=new AlertDialog.Builder(TandaiDestroy.this);
                adb.setTitle("Tandai Destroy");
    ...
    private void insertdata(){
        ...
        try {
            json.put("service", "setTandaiDestroy");
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(TandaiDestroy.this, getString(R.string.error_connection), Toast.LENGTH_LONG).show();
...
//                                Log.d("hasil soap data", ""+d.getJSONObject(1).getString("status"));
                                if (d.getJSONObject(1).getString("status").equals("1")){
                                    Intent pindah = new Intent(TandaiDestroy.this, HasilProses.class);
                                    pindah.putExtra("proses","ttkdestroy");
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(TandaiDestroy.this, "Mohon Cek Kembali TTK Anda",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }else{
                            ...
                            progressDialog.dismiss();
                            Intent pindah = new Intent(TandaiDestroy.this, HasilError.class);
                            pindah.putExtra("proses","ttkdestroy");
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(TandaiDestroy.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        });
                    }
    ...
    private boolean validateKode() {
        if (input_ttk.getText().toString().trim().isEmpty()) {
            ...
            Toast.makeText(TandaiDestroy.this,"Masukkan Nomor TTK", Toast.LENGTH_LONG).show();
        ...
        if (imageView.getDrawable() == null){
            Toast.makeText(TandaiDestroy.this, "Mohon Masukkan Foto", Toast.LENGTH_SHORT).show();
            return false;
        }
