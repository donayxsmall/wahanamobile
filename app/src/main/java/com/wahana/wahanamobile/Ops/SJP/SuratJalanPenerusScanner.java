...
public class SuratJalanPenerusScanner extends Activity implements ZBarScannerView.ResultHandler {
    ...
    String ttkManual,employeeCode,via;
    int urut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suratjalanpenerus_scanner);
        progressDialog = new ProgressDialog(SuratJalanPenerusScanner.this, R.style.AppTheme_Dark_Dialog);

        Intent intent=getIntent();
        via=intent.getStringExtra("via");

        session = new SessionManager(SuratJalanPenerusScanner.this);
        employeeCode = session.getID();

        listTTK = (ListView) findViewById(R.id.list_ttk_daftar);
        db = new DatabaseHandler(SuratJalanPenerusScanner.this);
        ...
        addManual.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(SuratJalanPenerusScanner.this);
                alertDialog.setTitle("Input Manual TTK");
                alertDialog.setMessage("Masukkan no. TTK");

                final EditText input = new EditText(SuratJalanPenerusScanner.this);
...
//                                }
                                if (ttk==0){
                                    mySong=MediaPlayer.create(SuratJalanPenerusScanner.this, R.raw.success);
        ...
        listTTK.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                AlertDialog.Builder adb=new AlertDialog.Builder(SuratJalanPenerusScanner.this);
                ...
                adb.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        db.deleteTTKSJP(nottk.getText().toString());
                        populate();
                    }});
                adb.show();
            }
    ...
    private void submitForm() {
        ...
        ArrayList<String> ttks = db.getAllTtkSJPFix();
        JSONObject json = new JSONObject();
        try {
            json.put("service", "setDataSJP");
            json.put("employeeCode", employeeCode);
            json.put("penerus", via);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(SuratJalanPenerusScanner.this, getString(R.string.error_connection), Toast.LENGTH_LONG).show();
...
//                                Log.d("hasil soap data", ""+d.getJSONObject(1).getString("status"));
                                if (d.getJSONObject(1).getString("status").equals("1")){
                                    Intent pindah = new Intent(SuratJalanPenerusScanner.this, HasilProses.class);
                                    db.deleteBuatSJP();
...
//                                    pindah.putExtra("no", "SJP-123-123");
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(SuratJalanPenerusScanner.this, "Mohon Cek Kembali TTK Anda",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }else{
                            ...
                            progressDialog.dismiss();
                            Intent pindah = new Intent(SuratJalanPenerusScanner.this, HasilError.class);
                            pindah.putExtra("proses","sjp");
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(SuratJalanPenerusScanner.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        });
                    }
    ...
    private void populate(){
        ...
        Log.d("Hasil", ""+ttkList);
        adapter = new BuatSJAdapter(SuratJalanPenerusScanner.this, ttkList, urut);
    ...
    public void handleResult(Result rawResult) {
        int ttk = db.checkSJP(rawResult.getContents());
        Log.d("Hasil", ""+ttk);
...
//        }
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                mScannerView.resumeCameraPreview(SuratJalanPenerusScanner.this);
            }
        }, 2000);
    }
