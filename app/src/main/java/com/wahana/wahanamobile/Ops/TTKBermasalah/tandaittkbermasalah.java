package com.wahana.wahanamobile.Ops.TTKBermasalah;
...
public class tandaittkbermasalah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tandaittkbermasalah);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(tandaittkbermasalah.this, OpsMainActivity.class);
        ...
        progressDialog = new ProgressDialog(tandaittkbermasalah.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(tandaittkbermasalah.this);
        ...
        jenismasalah=(Spinner)findViewById(R.id.jenismasalah);
        ...
        jenismasalah.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
...
//                }
        ...
        btn_submit_foto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(tandaittkbermasalah.this, Camerates.class);
        ...
        btnInput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
//                submitForm();
                AlertDialog.Builder adb=new AlertDialog.Builder(tandaittkbermasalah.this);
    ...
    private void insertdata(){
        ...
        try {
            json.put("service", "setTandaiTTKBermasalah");
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(tandaittkbermasalah.this, getString(R.string.error_connection), Toast.LENGTH_LONG).show();
...
//                                Log.d("hasil soap data", ""+d.getJSONObject(1).getString("status"));
                                if (d.getJSONObject(1).getString("status").equals("1")){
                                    Intent pindah = new Intent(tandaittkbermasalah.this, HasilProses.class);
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(tandaittkbermasalah.this, "Mohon Cek Kembali TTK Anda",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }else{
                            ...
                            progressDialog.dismiss();
                            Intent pindah = new Intent(tandaittkbermasalah.this, HasilError.class);
                            pindah.putExtra("proses","ttkbermasalah");
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                Toast.makeText(tandaittkbermasalah.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        });
                    }
    ...
    private void getJenisMasalah(){
        ArrayList<String> parameter = new ArrayList<String>();
        parameter.add("doSSQL");
        parameter.add(session.getSessionID());
        parameter.add("getJenisBermasalah");
        parameter.add("0");
        parameter.add("50");
        parameter.add("0");
        parameter.add("0");
...
//                                            prov.setProvince("0");
                                    ...
                                    runOnUiThread(new Runnable() {
                                        public void run() {
                                            Toast.makeText(tandaittkbermasalah.this, "Mohon periksa kembali data Anda",Toast.LENGTH_LONG).show();
                                        }
                                    });
                                }
                            }else{
    ...
    private void populateSpinner() {
        ...
        jenismasalah.setAdapter(spinnerAdapter);
    }
    ...
    private boolean validateKode() {
        if (input_ttk.getText().toString().trim().isEmpty()) {
            ...
            Toast.makeText(tandaittkbermasalah.this,"Masukkan Nomor TTK", Toast.LENGTH_LONG).show();
        ...
        if (imageView.getDrawable() == null){
            Toast.makeText(tandaittkbermasalah.this, "Mohon Masukkan Foto", Toast.LENGTH_SHORT).show();
            return false;
        }
