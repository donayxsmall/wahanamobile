...
public class InputNikSupir extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_input_nik_supir);
        ...
        db = new DatabaseHandler(InputNikSupir.this);

        progressDialog = new ProgressDialog(InputNikSupir.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(InputNikSupir.this);
...
//                        Log.d("retro",""+vurl);
                        ...
                        Toast.makeText(InputNikSupir.this," error "+vrmsg,Toast.LENGTH_SHORT).show();
                    }
