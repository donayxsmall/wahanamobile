...
public class inputtksalahdestinasi extends DrawerHelper {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(inputtksalahdestinasi.this, R.style.AppTheme_Dark_Dialog);
        session = new SessionManager(inputtksalahdestinasi.this);
            ...
            protected void onPostExecute(SoapObject result) {
                ...
                if(result==null){
                    runOnUiThread(new Runnable() {
                        public void run() {
                            Toast.makeText(inputtksalahdestinasi.this, getString(R.string.error_message), Toast.LENGTH_LONG).show();
                    ...
                    try{
                        ...
                        if (text.equals("OK")) {
                            ...
                            if (data.length()>1){
                                ...
                                Intent pindah = new Intent(inputtksalahdestinasi.this, tandaisalahdestinasi.class);
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(inputtksalahdestinasi.this, "TTK tidak ditemukan",Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
                        }else{
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    Toast.makeText(inputtksalahdestinasi.this, text,Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                    }catch (Exception e){
