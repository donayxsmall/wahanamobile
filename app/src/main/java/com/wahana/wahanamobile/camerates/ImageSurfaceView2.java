...
public class ImageSurfaceView2 extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public ImageSurfaceView2(Context context, Camera camera){
        super(context);
    ...
    public ImageSurfaceView2(Activity activity, Camera camera, int cameraId){
        super(activity);
